...
/**
 * v3.10: rate limit KHUSUS /api/auth/login -- jauh lebih ketat daripada
 * generalLimiter (60/menit), karena endpoint ini rawan brute-force nebak
 * password. 10 percobaan/menit per IP cukup longgar untuk user yang salah
 * ketik beberapa kali, tapi terlalu lambat untuk brute-force efektif.
 */
