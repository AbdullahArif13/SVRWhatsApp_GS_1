...
// ("terkirim" | "gagal" | "antri"), ditampilkan pakai label yang sama
// seperti StatusBadge.
...
export default function MessageHistory() {
  ...
  // v3.5: log yang lagi dibuka popup alasan Reject-nya (beda dari
  // viewingLog di atas -- itu buat detail lengkap pesan, ini khusus
  // alasan Reject doang, dibuka dari klik badge "Reject" di tabel).
  ...
  // Balik ke halaman 1 tiap kali hasil filter/search berubah, supaya user
  // tidak nyasar di halaman lama yang isinya udah beda.
  useEffect(() => {
  ...
  return (
    <Layout>
      {/* h-[calc(100vh-4rem)] (bukan h-full) supaya halaman ini selalu
          mengisi penuh sisa layar di bawah TopBar (TopBar h-16 / 4rem),
          sama seperti pola yang dipakai di Chat.jsx. */}
