...
export default function TemplatesView({
  ...
  return (
    <Layout>
        ...
        <div className="shrink-0">
          ...
          <div className="px-8">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-4">
              ...
              />
              <FilterSelect options={approvalOptions} value={approvalFilter} onChange={setApprovalFilter} />
                  ...
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand transition-colors hover:bg-brand-hover-200 disabled:opacity-50"
                      >
      ...
      {viewingTemplate && <TemplateDetailModal template={viewingTemplate} onClose={() => setViewingTemplate(null)} />}
